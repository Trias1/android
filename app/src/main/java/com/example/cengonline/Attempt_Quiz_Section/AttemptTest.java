...
package com.example.cengonline.Attempt_Quiz_Section;
...
import com.example.cengonline.NotificationActivity.NotificationService;
import com.example.cengonline.R;
import com.example.cengonline.model.Question;
import com.example.cengonline.model.Test;
import com.example.cengonline.ui.course.QuizFragment;
...
public class AttemptTest extends AppCompatActivity {
    ...
    public AttemptTest(QuizFragment quizFragment, ArrayList<Test> questions) {
    }
    ...
    void submit(){
        ...
        try {
            mDatabase.child("Results").child(((Test) getIntent().getExtras().get("Questions")).getName())
                    .child(firebaseAuth.getUid()).setValue(score);
        }catch (Exception e){
