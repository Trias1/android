package com.example.cengonline.Create_Quiz;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cont)
                {
                    previousQuestion++;
                    currentQuestion++;
                    Toast.makeText(CustomQuiz.this, "QUESTION " + currentQuestion, Toast.LENGTH_SHORT).show();
                    questionNumber.setText(String.valueOf(currentQuestion));
                    clearAllData();
                    f2.setVisibility(View.VISIBLE);
                }
...
//                                         result.setText(userInput.getText());
                                                ...
                                                if (!TextUtils.isEmpty(fileName))
                                                    myRef.child("test").child(fileName).setValue(result);
                                            }
                                        }
                                    })
